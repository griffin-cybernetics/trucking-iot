...
curl 'http://gcs-nifi-c02n01.local.griffin-nc.com:9090/nifi-api/flow/process-groups/90e748c3-015a-1000-f68d-292036f42e8f' -X PUT -H 'Content-Type: application/json' -H 'X-Requested-With: XMLHttpRequest' --data-binary '{"id":"90e748c3-015a-1000-f68d-292036f42e8f","state":"RUNNING"}' --compressed
